class PaddingConsts
{
    ...
    static const double INHERENT_BUTTON_PADDING_HORIZONTAL = 0;
    ...
    static const double INHERENT_CUPERTINO_BUTTON_PADDING_HORIZONTAL = 0;
    static const double INHERENT_CUPERTINO_BUTTON_PADDING_VERTICAL = 0;

    static const double GLOBAL_BASE_PADDING = 0;
